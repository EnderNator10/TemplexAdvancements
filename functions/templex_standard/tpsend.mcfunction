...
execute @s[score_TPSR=1] ~ ~ ~ tellraw @s [{"text":"TPSend request sent.","color":"green"},{"text":"\nNow tell the other person to type ","color":"gray"},{"text":"\"","color":"dark_gray"},{"text":"/","color":"aqua"},{"text":"trigger TPHere set 1","color":"gold"},{"text":"\"","color":"dark_gray"},{"text":".","color":"gray"},{"text":" They have five seconds to send their request.","color":"red"}]
