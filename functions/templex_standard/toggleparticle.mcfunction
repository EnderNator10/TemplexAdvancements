...
execute @s[tag=POR] ~ ~ ~ tellraw @a[tag=OP] [{"text":"Toggle Particle System","color":"gold"},{"text":" : ","color":"dark_gray"},{"text":"Toggled ","color":"red"},{"selector":"@s"},{$
execute @s[tag=POR] ~ ~ ~ tellraw @s [{"text":"Toggled your particles \u00A7aON\u00A7c!","color":"red"}]
...
execute @s[tag=POA] ~ ~ ~ tellraw @a[tag=OP] [{"text":"Toggle Particle System","color":"gold"},{"text":" : ","color":"dark_gray"},{"text":"Toggled ","color":"red"},{"selector":"@s"},{$
execute @s[tag=POA] ~ ~ ~ telraw @s [{"text":"Toggled your particles \u00A74OFF\u00A7c!","color":"red"}]
...
execute @s[tag=POA] ~ ~ ~ scoreboard players set @s PartOn 0
