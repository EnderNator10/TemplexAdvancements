...
execute @s[score_Dummy_min=3,score_Dummy=6] ~ ~ ~ scoreboard players tag @s add Started
...
#### Need to have "@p[r=100,m=!1,tag=!RunCmplt]"
...
execute @a[score_Dummy_min=120,score_Dummy=120,tag=InRun] ~ ~ ~ scoreboard players tag @s remove Started
