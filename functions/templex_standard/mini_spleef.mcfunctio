...
execute @a[tag=!InShovel,r=100,m=2] ~ ~ ~ scoreboard players set Z Spleef 0
execute @a[tag=!InShovel,r=100,m=2] ~ ~ ~ scoreboard players tag @a remove SpleefAdded
scoreboard players tag @a[tag=!InSpleef,r=100,m=2] add InShovel
execute @a[r=100,tag=!ShovelAdded] ~ ~ ~ scoreboard players add Z Spleef 1
execute @a[r=100,tag=!ShovelAdded] ~ ~ ~ scoreboard players tag @s add SpleefAdded
...
execute @a[score_Dummy_min=120,score_Dummy=120,tag=InSpleef] ~ ~ ~ scoreboard players set Z Shovel 0
