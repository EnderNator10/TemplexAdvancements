...
execute @s[team=HeadMod] ~ ~ ~ particle endRod ~ ~ ~ 1 1 1 0.001 1 force @a
...
execute @s[team=VIPP] ~ ~ ~ particle portal ~ ~ ~ 1 1 1 0.001 5 force @a
execute @s[team=MVP] ~ ~ ~ particle explode ~ ~ ~ 1 1 1 0.001 1 force @a
execute @s[team=MVPP] ~ ~ ~ particle lava ~ ~ ~ 1 1 1 0.001 1 force @a
execute @s[team=DNRP] ~ ~ ~ particle depthsuspend ~ ~ ~ 1 1 1 0.001 1 force @a
...
execute @s[team=Legend] ~ ~ ~ particle flame ~ ~ ~ 1 1 1 0.01 2 force @a
execute @a[team=Lord] ~ ~ ~ particle flame ~ ~ ~ 1 1 1 0.01 2 force @a
